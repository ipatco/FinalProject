                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <table class="table table-responsive-sm text-center">
                                ...
                                <tbody>
                                    <tr>
                                        <td><img class="media-object round-media height-50" src="{{ asset('app-assets/img/elements/01.png') }}" alt="Generic placeholder image" /></td>
                                    ...
                                    <tr>
                                        <td><img class="media-object round-media height-50" src="{{ asset('app-assets/img/elements/07.png') }}" alt="Generic placeholder image" /></td>
                                        <td>Headphones</td>
                                        <td>2</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img class="media-object round-media height-50" src="{{ asset('app-assets/img/elements/11.png') }}" alt="Generic placeholder image" /></td>
                                        <td>Camera</td>
                                        <td>1</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img class="media-object round-media height-50" src="{{ asset('app-assets/img/elements/14.png') }}" alt="Generic placeholder image" /></td>
                                        <td>Beer</td>
                                        <td>2</td>
                                        <td>
