	...
	<body class="g-sidenav-show  bg-gray-200">
		<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
			...
			<div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
				<ul class="navbar-nav">
					<li class="nav-item">
						<a class="nav-link text-white {{ request()->url() == route('instructor.profile')?' active bg-gradient-primary':'' }}" href="{{ route('instructor.profile') }}">
					...
					<li class="nav-item">
						<a class="nav-link text-white {{ request()->url() == route('instructor.students')?' active bg-gradient-primary':'' }}" href="{{ route('instructor.students') }}">
							<div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
					...
					<li class="nav-item">
						<a class="nav-link text-white {{ request()->url() == route('instructor.meeting')?' active bg-gradient-primary':'' }}" href="{{ route('instructor.meeting') }}">
							<div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
