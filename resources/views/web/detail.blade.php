													...
													<div class="row">
														...
														@if ($benifit->type == 'feature')
															<div class="col-md-6 mb-3">
																<img src="{{ asset($benifit->icon_img) }}" alt="Image" class="mr-3">
																{{ $benifit->text }}
															</div>
														@endif
														@endforeach
													...
													<div class="row">
														@if ($course->courseTool)
															...
															<div class="thisSkill col-md-2 col-sm-2">
																<img src="{{ asset($tool->image) }}" class="img-fluid mh-150">
															</div>
															@endforeach
														@endif
													</div>
												...
												<div class="s_feeback_content">
													<div class="row">
														...
														<div class="col-md-5 text-center">
															@if ($course->offer_price > 0 && $course->offer_ends != '')
																<h3 class="mt-5"><s>₹ {{ $course->offer_price }}</s></h3>
																<span class="offer">{{ $course->discount_text }}</span>
																<h3>₹ {{ $course->price }}</h3>
